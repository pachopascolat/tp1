            ...
            <div class="container">
                <div class="w-100 d-flex">
                    <a class="navbar-brand d-flex align-items-end" href="/">
                        <img class="logo-texsim-blanco p-0" src="<?= \yii\helpers\Url::base(true)."/img/logotexsim-02.svg" ?>">
...
//                                );
                            ...
                            <div class="menu-div d-flex justify-content-end">
                                ...
                                <form method="POST" action="<?= \yii\helpers\Url::to(['/texsim/buscar-telas']) ?>"  class="form-inline my-2 my-lg-0 navbar-link flex-fill">
                                    ...
                                    <img src="<?= \yii\helpers\Url::base(true)."/img/lupa-01.svg" ?>" class="lupa-icon"></img>
        ...
        <nav class="navbar-movil navbar navbar-texsim navbar-dark">
            <div class="container">
                <div id="movil-search-input" class="w-100 collapse ">
                    <form method="POST" action="<?= \yii\helpers\Url::to(['/texsim/buscar-telas']) ?>"  class="form-inline my-2 my-lg-0 navbar-link flex-fill">
                        <input id="busqueda-movil" name="busqueda" class="form-control texsim-search-input nav-item w-100" type="search" placeholder="" aria-label="Search">
                        <!--<i class="fa fa-search text-light"></i>-->
                        <img src="" class="lupa-icon"></img>
                        <img src="<?= \yii\helpers\Url::base(true)."/img/lupa-01.svg" ?>" class="lupa-icon"></img>
                        <!--<img src="img/lupa-01.svg" class="lupa-icon"></img>-->
                        <!--<button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>-->
                    </form>
        ...
        <div class="modal-content">
            <div class="modal-header pb-2">
                <a class="navbar-brand d-flex align-items-end w-100 pr-3 pb-0" href="/">
                    <img class=" img-fluid p-0 " src="<?= \yii\helpers\Url::base(true)."/img/logotexsim-02.svg" ?>">
            ...
            <div class="modal-body">
                <div class="side-menu-link text-white cursor-pointer pb-3" data-toggle="collapse"  data-target="#movil-search-input">
                    <span>Buscador</span>
                    <img src="<?= \yii\helpers\Url::base(true)."/img/lupa-01.svg" ?>" class="lupa-toggle-icon"></img>
                </div>

...
<!--                    <a class="btn btn-outline-dark" href="https://api.whatsapp.com/send?phone=541135386219&text=<?= rawurlencode($carrito->getConsultaWhatsApp()) ?>&source=&data=#" >Pedido por WhatsApp 
                ...
                <a href="<?= \yii\helpers\Url::to(['update-consulta', 'id_carrito' => $id_carrito, 'categoria_padre' => $categoria_padre]) ?>" class="btn btn-outline-dark">Modificá tu consulta</a></p>
                <p> <a href="<?= \yii\helpers\Url::to(['hogar', 'categoria_padre' => $categoria_padre]) ?>" class="btn btn-outline-dark">Finalizar</a></p>
            </div>
        </section>

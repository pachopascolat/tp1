<?php
$iconos = common\models\Vidriera::find()->where(['categoria_id' => common\models\Categoria::ICONOS])->limit(8)->orderBy('orden_vidriera')->all();
$iconosFilas = array_chunk($iconos, 4);
?>

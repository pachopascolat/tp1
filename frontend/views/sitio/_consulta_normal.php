...
//                                    'enableAjaxValidation' => true,
                        ...
                        <div class="d-flex justify-content-between flex-column flex-lg-row loading-div mt-4">
                            ...
                            <div class="form-group text-center">
                                <button data-pjax=0 type="submit" class="btn-pedido btn btn-outline-secondary">
                            ...
                            <div class="form-group text-center">
                                <button data-pjax=0 type="submit" formaction="<?php echo \yii\helpers\Url::to(['crear-consulta-whats-app']) ?>" id="consulta-whatsapp" type="" class="btn-pedido btn btn-outline-secondary">

<div class="fila-imagen-redes-dos mt-5">
    <div class="container">
        <h3 class="pr-5" >En las redes</h3>
        <div class="row mt-4">
            <div class="col-4 pl-1">
                <a href="#!">
                            <img class="disenio-img img-fluid" src="<?= yii\helpers\Url::base(true)?>/img2020/texsim-redes-feria.jpg">
                </a>  
            </div>    

<div class="stock-template">
    ...
    <a name="" id="" class="btn btn-primary btn-sm p-1" href="<?=\yii\helpers\Url::to(['/test/estado-pedido/crear-pedido'])?>" role="button">Nuevo</a>
    <a name="" id="" class="btn btn-danger btn-sm p-1" href="<?=\yii\helpers\Url::to(['/test/estado-pedido/index'])?>" role="button">Pedidos</a>
    </div>

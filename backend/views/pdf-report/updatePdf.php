...
//    echo $form->field($model, 'guardar')->checkbox();
    ...
    <button id="pdf-button" name="pdf-button" 
            ...
            >PDF</button>
        <?= \yii\helpers\Html::a('Agregar Items', ['/vidriera/ordenar-vidriera','id'=>$model->vidriera_id], ['class'=>'btn btn-primary'])?>
    </p>
    <?php ActiveForm::end(); ?>
...
//    $dataProvider = $articuloSearch->search(null);
//    $dataProvider->getPagination()->setPageSize(100);
    ?>
    <?php
//    echo $this->render('/vidriera/_modal_nuevo_item', [
//        'vidriera' => $model->vidriera ?? new common\models\Vidriera(),

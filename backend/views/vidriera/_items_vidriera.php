    ...
    <div id='sortable' class="d-flex">
        ...
        foreach ($vidriera->itemVidireras as $item):
            ...
            <div id="<?= $item->id_item_vidriera ?>" class="items-vidrieras">
                ...
                <!--<a data-pjax='false' data-id-item="<?= $item->id_item_vidriera ?>" data-confirm="Esta seguro quiere borrar item?" class="delete-item-btn" >-->
                <i data-id-item="<?= $item->id_item_vidriera ?>" class="fa fa-times fa-2x delete-item-btn"></i>
                <!--</a>-->
                ...
                <span><?= "{$item->articulo->codigo_color} {$item->articulo->nombre_color}" ?></span>
            </div>
